...
software.  The [gusdunn channel](https://anaconda.org/gusdunn) is a Conda
channel providing personal and bioinformatics related packages.  This repository hosts the
corresponding recipes.

## User guide

This channel is based almost verbatim on the ideas and structure of the Bioconda project.
